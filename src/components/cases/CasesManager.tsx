...
export function CasesManager({
  ...
  // Filter cases by clientId if provided
  const filteredCasesByClient = useMemo(() => {
  ...
  const filteredAndSortedItems = useMemo(() => {
    if (!filteredCasesByClient.length) return [];
    ...
    const filtered = filteredCasesByClient.filter((c) => {
